  ...
  const EngineeringTabsSlider = () => {
    ...
    return (
      <div className="relative w-full overflow-hidden py-8 sm:py-12 md:py-16 lg:py-20 min-h-screen bg-[#0a0e1a]">
        ...
        {/* Tower Background Image Overlay */}
        <div className="absolute inset-0 opacity-[0.05]">
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#0a0e1a]/30 to-[#0a0e1a]/80"></div>
          <img 
            src="/images/home/towerimage.png" 
            alt="Power Tower" 
